        ...
        for line in fp.readlines():
            ...
            if img_bbox[0] != 'img':
                ...
                with open(img_bbox_filename, 'w') as f:
                    f.write('1\n')
                    f.write('{0} {1} {2} {3} {4}'.format(img_bbox[1], img_bbox[4], img_bbox[3], img_bbox[2], classname))
                    f.close()
                ...
                with open(yolo_label_filename, 'w') as f:
                    ...
                    if (yolo_bbox[2] > 1) or (yolo_bbox[3] > 1):
                        print("image {} bbox is ".format(image_filename)
...
for id in classid2name.keys():
    print("generating {0} {1}".format(id, classid2name[id]))
